...
func (this *UserAoModel) GetByName_WithError(username string) (_fishgen1 []User, _fishgenErr Exception) {
	defer Catch(func(exception Exception) {
		_fishgenErr = exception
	})
	_fishgen1 = this.GetByName(username)
	return
}

func (this *UserAoModel) Add_WithError(user User) (_fishgen1 int, _fishgenErr Exception) {
	defer Catch(func(exception Exception) {
		_fishgenErr = exception
	})
	_fishgen1 = this.Add(user)
	return
}
...
func (this *UserDbModel) Add_WithError(user User) (_fishgen1 int, _fishgenErr Exception) {
	defer Catch(func(exception Exception) {
		_fishgenErr = exception
	})
	_fishgen1 = this.Add(user)
