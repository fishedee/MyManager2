...
func (this *CategoryAoTest) testGet(categorys []Category) {
	...
	this.AssertError(err3, 1, "该88888类型不存在")
}
...
func (this *CategoryAoTest) testMod(categorys []Category) {
	...
	this.CategoryAo.Mod(10001, modCategory)
	categorys[0] = modCategory
	this.assertCategoryEqual(categorys)

	//修改不属于他的分类
	err4 := this.CategoryAo.Mod_WithError(10002, Category{
		CategoryId: 10001,
		UserId:     10001,
		Name:       "黑客",
		Remark:     "被黑了",
	...
	//修改不存在的分类
	err5 := this.CategoryAo.Mod_WithError(10001, Category{
		CategoryId: 99999,
		UserId:     10001,
		Name:       "黑客",
		Remark:     "被黑了",
	})
	this.AssertError(err5, 1, "该99999类型不存在")
}
...
func (this *CategoryAoTest) testDel(categorys []Category) {
	...
	this.AssertError(err7, 1, "该99999类型不存在")
